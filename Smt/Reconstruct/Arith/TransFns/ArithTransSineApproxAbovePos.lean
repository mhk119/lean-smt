...
theorem arithTransSineApproxAbovePos (d n : ℕ) (_ : d = 4*k + 1)
                                     (hx : 0 < x) (hx2 : x ≤ π) :
    ...
    simp only [this, iteratedDeriv_sin_cos, reduceIte, one_ne_zero, sub_zero, show 1 ≠ 3 by decide, show 1 ≠ 2 by decide]
